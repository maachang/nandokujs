...
// min
var x = 'return (function(r){var n=String(r).replace(/[=]+$/,"");if(n.length%4!=1){for(var a,e,t=0,f=0,i="";e=n.charAt(f++);~e&&(a=t%4?64*a+e:e,t++%4)?i+=String.fromCharCode(255&a>>(-2*t&6)):0)e="0123456789+abcdefghijklmnopqrstuvwxyz/ABCDEFGHIJKLMNOPQRSTUVWXYZ=".indexOf(e);return i}})($V)'
